...
export default function CommonBugsPage() {
  ...
  return(<div className="space-y-4">
    ...
    {showForm&&<BugModal supabase={supabase} devs={devs} editId={showForm.id} table="common_bugs" title="공통 오류" versionList={allVers} userName={userName} onClose={closeForm} onSaved={afterSave} onDel={handleDel}/>}
  </div>);
}
