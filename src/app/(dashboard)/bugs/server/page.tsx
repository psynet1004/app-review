...
export default function ServerBugsPage() {
  ...
  return(<div className="space-y-4">
    ...
    {showForm&&<BugModal supabase={supabase} devTeam={devTeam} editId={showForm.id} table="server_bugs" title="서버 오류" versionList={allVers} userName={userName} userDept={userDept} onClose={closeForm} onSaved={afterSave} onDel={handleDel}/>}
  </div>);
}
