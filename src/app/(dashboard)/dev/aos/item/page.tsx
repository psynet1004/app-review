...
export default function AosItemPageWrapper(){
  return <Suspense fallback={null}><AosItemPage/></Suspense>;
}

function AosItemPage(){
  ...
  const save=async()=>{
    ...
    if(editId){
      ...
      // 새로 추가되고 포함된 항목만 insert / 기존 항목인데 제외로 바뀐 건 delete
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="sticky top-0 z-10 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-700 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button onClick={()=>router.push('/dev/aos')} className="p-1.5 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800">
      ...
      <div className="sticky bottom-0 bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-700 px-6 py-4 flex justify-between max-w-6xl mx-auto">
        ...
        <div className="flex gap-2">
          <button onClick={()=>router.push('/dev/aos')} className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 dark:hover:bg-neutral-800 rounded-lg">취소</button>
